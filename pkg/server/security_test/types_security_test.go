...
func TestSecurity_GREEN_CompleteTaskRequest_FilesModifiedUnboundedSlice(t *testing.T) {
	...
	err := sharedValidator.Struct(req)
	assert.Error(t, err, "GREEN: 100 000 FilesModified items must be rejected by validation")
}
