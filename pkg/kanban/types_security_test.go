...
// Security tests for pkg/kanban types.go
//
...
import (
	...
	kanban "github.com/JLugagne/agach-mcp/pkg/kanban"
)
...
//
// File: pkg/kanban/types.go line 54
...
//
// File: pkg/kanban/types.go line 96
...
//
// File: pkg/kanban/types.go line 97
// Tag: `validate:"dive,max=50"`  ← missing `max=N` on the slice itself
...
//
// File: pkg/kanban/types.go line 99
...
func TestSecurity_GREEN_ReorderTaskRequest_ZeroPositionAccepted(t *testing.T) {
	req := kanban.ReorderTaskRequest{Position: 0}
	err := sharedValidator.Struct(req)
...
func TestSecurity_GREEN_ReorderTaskRequest_NegativePositionRejected(t *testing.T) {
	req := kanban.ReorderTaskRequest{Position: -1}
	err := sharedValidator.Struct(req)
...
//
// File: pkg/kanban/types.go line 56 (CreateRoleRequest) and line 68 (UpdateRoleRequest)
...
//
// File: pkg/kanban/types.go line 134
