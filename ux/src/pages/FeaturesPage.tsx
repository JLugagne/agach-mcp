    ...
    <div className="flex flex-col h-full">
      <div className="flex items-center justify-between px-6 py-4 border-b border-[#1E1E1E]">
        ...
        <button
          ...
          data-qa="close-feature-drawer-btn"
    ...
    <SettingsLayout projectName={project?.name ?? 'Project'} rightDrawer={rightDrawer}>
      ...
      {showCreate && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          <div className="absolute inset-0 bg-black/60" onClick={() => setShowCreate(false)} data-qa="create-feature-modal-backdrop" />
