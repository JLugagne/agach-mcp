...
func (h *ProjectAgentCommandsHandler) AssignAgent(w http.ResponseWriter, r *http.Request) {
	...
	var req pkgserver.AssignAgentToProjectRequest
	if err := h.controller.DecodeAndValidate(r, &req, pkgserver.ErrInvalidAgentAssignmentRequest); err != nil {
		h.controller.SendFail(w, r, nil, errors.Join(pkgserver.ErrInvalidAgentAssignmentRequest, err))
		return
	}
...
func (h *ProjectAgentCommandsHandler) BulkReassign(w http.ResponseWriter, r *http.Request) {
	...
	var req pkgserver.BulkReassignTasksRequest
	if err := h.controller.DecodeAndValidate(r, &req, pkgserver.ErrInvalidAgentAssignmentRequest); err != nil {
		h.controller.SendFail(w, r, nil, errors.Join(pkgserver.ErrInvalidAgentAssignmentRequest, err))
		return
	}
	...
	h.controller.SendSuccess(w, r, pkgserver.BulkReassignTasksResponse{UpdatedCount: n})
}
